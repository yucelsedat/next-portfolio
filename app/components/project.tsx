...
export default function Project({ title, description, tags, imageUrl }: ProjectData) {
  ...
  return (
    ...
    >
      <section className=" relative bg-gray-100 max-w-[42rem] rounded-lg border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem]  hover:bg-gray-200 transition">

        <div className="group-even:absolute group-even:right-0 flex flex-col h-full px-5 pt-4 pb-7 text-left sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[55%]">
